...
export function CabinetPage() {
  ...
  return <div className="cabinet-page">
    <header className="cabinet-hero"><span>THE CABINET OF FOUND LIGHT · 拾光橱 · 我的收藏</span><h1 className="gothic-display-title">Cabinet<br />of Light</h1><p>把偶然击中你的句子与图像陈列起来。它们不必立即成为方法，也可以只是值得反复凝视的光。</p><button onClick={() => document.getElementById("cabinet-compose")?.scrollIntoView({ behavior: "smooth" })}>放入一件新收藏 ↓</button></header>
